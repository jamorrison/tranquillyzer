...
_VERSION_PATH = _REPO_ROOT / "_version.py"


def _load_version_module():
    """Load repo-root _version.py by path (generated by setuptools_scm at build time)."""
    spec = importlib.util.spec_from_file_location("tranquillyzer_root_version", _VERSION_PATH)
...
def test_version_module_exports():
    ...
    if not _VERSION_PATH.exists():
        pytest.skip("_version.py not generated (setuptools_scm did not run)")
